...
- [x] M2-ext: 图片系统 — 文件/截图/粘贴插入、缩放手柄、裁剪、宽高比锁定、资源文件化存储
- [x] M2-ext: 工具栏分类标签 — 文件/插入/图片编辑/绘图/同步多标签
...
- [x] M2-ext: 绘图功能 — 铅笔/画笔/橡皮/颜料桶/取色器/图形/缩放
- [x] M3: 编辑增强 — 查找替换、行号、快捷键体系、首选项、tooltip、格式迁移
- [x] M3: 图片资源文件化 — 图片/绘画保存为独立文件，旧格式自动迁移
- [x] M3: 视频插入 — 本地视频、缩放手柄、CSS容器裁剪、复制粘贴跨笔记
- [x] M3: 跨平台打包 — electron-builder + NSIS 安装器
- [x] M5: 云端同步 — Git 同步（pull/push）、冲突检测与解决
- [ ] M3: 体验版剩余 — 日历视图、全文搜索、标签系统
