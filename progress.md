...
- **Current Objective / 当前活跃功能**: M3 体验版进行中 (8/11 完成)；F-051 应用自动更新已完成
...
- **Files Modified / 最近修改文件**: `package.json`, `main.js`, `preload.js`, `update-checker.js`, `js/settings-ui.js`, `index.html`, `css/settings.css`, `docs/git_workflow.md`, `feature_list.json`
- **Last Updated / 最后更新**: 2026-07-08
