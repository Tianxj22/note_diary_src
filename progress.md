...
- **Current Objective / 当前活跃功能**: M3 体验版进行中 (8/11 完成)；F-033 图片资源文件化 + F-034 视频插入及编辑已完成
...
- **Files Modified / 最近修改文件**: `main.js`, `preload.js`, `file-store.js`, `js/editor-core.js`, `js/insert-features.js`, `js/image-resize.js`, `js/editor-events.js`, `js/context-menus.js`, `js/edit-toolbar.js`, `js/state.js`, `js/init.js`, `index.html`, `css/editor.css`, `css/image-resize.css`, `keybindings-store.js`, `feature_list.json`, `test/unit/clipboard-media.test.mjs`
